...
export default () => {
  ...
  const menuList2 = menuList.map(menu => {
    return menu.children
      ? {
          path: menu.path,
          name: menu.label[locale],
          routes: menu.children.map(child => ({
            path: child.path,
            name: child.label[locale],
          })),
        }
      : {
          path: menu.path,
  ...
  // console.log({path:"/",routes:menuList2})
  // console.log(defaultProps.route)
          ...
          <ProLayout
            ...
            menuProps={{
              onClick: ({ key }) => {
                // debugger
                navigate(key || '/')
                // setPathname(key || '/welcome');
              }
            }}
            // {...defaultProps}
            route={{path:'/',routes:menuList2}}
